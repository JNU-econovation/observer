...
class DefaultSerializerTest {
    ...
    private static final long TRANSACTION_START_TIME = 1234454359l;
    ...
    public void serializeTest() {
        MysqlTransactionDto mysqlTransactionDto = new MysqlTransactionDto(DB_HOST, AGENT_HOST, SERVICE_NAME, TRANSACTION_START_TIME, TRANSACTION_TIME_MILLIS);
